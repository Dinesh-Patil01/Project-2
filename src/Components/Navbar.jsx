  ...
  return (
    <>
        ...
        >
          ...
          <HStack spacing={8} alignItems={"center"}>
            <HomeLink to="/">
              <Box>
                <Image
                  src={`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSq6ETMUok1QEXwQqlMF90QDMdOKpvKGfrFA&s`}
                  ml="50px"
                  width="55%"
                />
              </Box>
      ...
      <Stack backgroundColor={"#F2F2F2"} mb="20px" mt="152px" width="100%">
        ...
        >
          <HStack>
            <Image src="https://img.icons8.com/?size=50&id=7880&format=png" />
            <Text>
      ...
      >
        ...
        >
          <Text fontSize={"20px"}>
            {" "}
            <b>
		            Shop Dermstore and receive TWO free gifts with any $200+ purchase. SHOP NOW
            </b>{" "}
          </Text>
        </HStack>
      </Stack>
